...
export const registerSchema = z.object({
  firstName: z.string().min(1, `full name should be in english alphabets`),
  lastName: z.string().min(1, `full name should be in english alphabets`),
...
//supabase auth user and session schemas
...
export interface UserSessionState {
  session?: Session;
  updateSession: (session: Session | undefined) => void;
}
